  ...
  return (
    <section className="  bg-gray-50">
      <div className="py-10 max-w-7xl mx-auto  px-5">
        <h1 className="text-4xl text-center font-medium ">Our team members</h1>
        <p className="text-center text-sm text-gray-500 my-4">
          Our team is a powerhouse of talent, passion, and dedication. We work
          together to achieve greatness and surpass all expectations. <br />{" "}
